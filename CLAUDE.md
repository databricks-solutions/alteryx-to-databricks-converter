...
- Test suite: ~1100 tests; CLI has 6 commands (added `verify`); `tests/unit/verification/` covers the harness and `tests/fixtures/expected_outputs/` holds golden CSVs.
