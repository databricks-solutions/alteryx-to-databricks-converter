...
- Test suite: ~1263 tests; CLI has 8 commands (`convert`, `analyze`, `portfolio`, `validate`, `verify`, `profile`, `list-tools`, `version`); `tests/unit/verification/` covers the harness and `tests/fixtures/expected_outputs/` holds golden CSVs.
