...
- Test suite: ~1294 tests; CLI has 9 commands (`convert`, `analyze`, `portfolio`, `validate`, `verify`, `assist`, `profile`, `list-tools`, `version`); `tests/unit/verification/` covers the harness and `tests/fixtures/expected_outputs/` holds golden CSVs.
